...
namespace SmartLaw.BLL
{
	...
	{
		private readonly SmartLaw.DAL.MySqlLog dal=new SmartLaw.DAL.MySqlLog();
		public Log()
		{}
		#region  BasicMethod
		/// <summary>
        ...
        /// 得到日志对象实体，从缓存中
		/// </summary>
		public SmartLaw.Model.Log GetModelByCache(long AutoID)
		{
			...
			return (SmartLaw.Model.Log)objModel;
		}
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>日志集合</returns>
        public List<SmartLaw.Model.Log> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<SmartLaw.Model.Log> DataTableToList(DataTable dt)
        {
            List<SmartLaw.Model.Log> modelList = new List<SmartLaw.Model.Log>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                SmartLaw.Model.Log model;
