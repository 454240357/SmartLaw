...
<%@ Register TagPrefix="custom" TagName="customControl" Src="~/Admin/NoticeManage/UserControl.ascx"  %>   
...
<table class="reDialog ManagerDialog NoMarginDialog" border="0" cellpadding="0"
	...
	<script type="text/javascript">
	    ...
	    function OnTreeContextMenuShown(oTreeMenu, args) {
	        ...
	        for (var i = 0; i < treeContextMenuItems.length; i++) {
	            ...
	            if (menuItem.get_value() == "NewFolder") {
	    ...
	    function OnGridClientShown(oGridMenu, args) {
