...
namespace SmartLaw.DAL
{
	...
	public partial class MySqlCategoryRegionalRelation
	{
		...
		public SmartLaw.Model.CategoryRegionalRelation GetModel(long AutoID)
		{
			...
			SmartLaw.Model.CategoryRegionalRelation model=new SmartLaw.Model.CategoryRegionalRelation();
		...
		/// 得到一个对象实体
		/// </summary>
		public SmartLaw.Model.CategoryRegionalRelation DataRowToModel(DataRow row)
		{
			SmartLaw.Model.CategoryRegionalRelation model=new SmartLaw.Model.CategoryRegionalRelation();
			if (row != null)
			{
